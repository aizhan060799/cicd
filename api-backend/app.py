...
# Setup with ENV variables (uncomment L23 if you are using local ENV VARS for DB credentials)
app.config["SQLALCHEMY_DATABASE_URI"] = (
    f"mysql+pymysql://{os.environ.get('DB_USERNAME')}:{os.environ.get('DB_PASSWORD')}@{os.environ.get('DB_ENDPOINT')}/{os.environ.get('DB_NAME')}"
)
